...
android_wlegl_create_handle(struct android_wlegl *android_wlegl, int32_t num_fds, struct wl_array *ints)
{
	...
	id = wl_proxy_marshal_flags((struct wl_proxy *) android_wlegl,
			 ANDROID_WLEGL_CREATE_HANDLE, &android_wlegl_handle_interface, wl_proxy_get_version((struct wl_proxy *) android_wlegl), 0, NULL, num_fds, ints);
...
android_wlegl_create_buffer(struct android_wlegl *android_wlegl, int32_t width, int32_t height, int32_t stride, int32_t format, int32_t usage, struct android_wlegl_handle *native_handle)
{
	...
	id = wl_proxy_marshal_flags((struct wl_proxy *) android_wlegl,
			 ANDROID_WLEGL_CREATE_BUFFER, &wl_buffer_interface, wl_proxy_get_version((struct wl_proxy *) android_wlegl), 0, NULL, width, height, stride, format, usage, native_handle);
...
android_wlegl_get_server_buffer_handle(struct android_wlegl *android_wlegl, int32_t width, int32_t height, int32_t format, int32_t usage)
{
	...
	id = wl_proxy_marshal_flags((struct wl_proxy *) android_wlegl,
			 ANDROID_WLEGL_GET_SERVER_BUFFER_HANDLE, &android_wlegl_server_buffer_handle_interface, wl_proxy_get_version((struct wl_proxy *) android_wlegl), 0, NULL, width, height, format, usage);
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) android_wlegl_handle,
			 ANDROID_WLEGL_HANDLE_ADD_FD, NULL, wl_proxy_get_version((struct wl_proxy *) android_wlegl_handle), 0, fd);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) android_wlegl_handle,
			 ANDROID_WLEGL_HANDLE_DESTROY, NULL, wl_proxy_get_version((struct wl_proxy *) android_wlegl_handle), WL_MARSHAL_FLAG_DESTROY);
}
